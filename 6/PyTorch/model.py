...
class DeepQNetwork(Module):
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.layer1 = Linear(state_dim, self.hidden_layer_size)
        self.layer2 = Linear(self.hidden_layer_size, self.hidden_layer_size)
        self.layer3 = Linear(self.hidden_layer_size, action_dim)
    ...
    def get_loss(self, states, Q_target):
        ...
        """
        return mse_loss(self.forward(states), tensor(Q_target))
    ...
    def forward(self, states):
        ...
        """
        return self.layer3(relu(self.layer2(relu(self.layer1(tensor(states))))))
